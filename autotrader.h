...
private:
    ...
    std::array<unsigned long, ReadyTraderGo::TOP_LEVEL_COUNT> mFutureAskPrices;
    std::array<unsigned long, ReadyTraderGo::TOP_LEVEL_COUNT> mFutureBidPrices;
    std::unordered_map<unsigned long, int> mBidTimes;
    std::unordered_map<unsigned long, int> mAskTimes;
